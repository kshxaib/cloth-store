...
const Footer = () => {
  return (
    <footer className="bg-black text-white mt-20 border-t-2 border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-display font-bold mb-4">DIVINE</h3>
          ...
          {/* Social */}
          <div>
            <h4 className="font-semibold mb-4 uppercase tracking-wide">FOLLOW US</h4>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Divine. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
